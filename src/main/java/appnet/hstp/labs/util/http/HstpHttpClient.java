...
import static appnet.hstp.labs.util.http.HttpClient.doPost;
...
//    }
    public static String hstpRequest(String url,String hstpUsl,String hstpAuth,Object body) throws Exception {
        return doPost(url, Map.of("hstp-usl",hstpUsl==null?"":hstpUsl,"hstp-auth",hstpAuth==null?"":hstpAuth),body);
    }
